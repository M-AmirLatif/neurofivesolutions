...
import {
  ...
  CalendarDays, LayoutDashboard, ListTodo, LoaderCircle, LogOut, Plus, RefreshCw, Search, Sparkles, Trash2, TrendingUp, UserRound, X, Zap
} from 'lucide-react';
  ...
  return (
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <div className="account-card"><div className="avatar"><UserRound size={17} /></div><div><strong>{user.name}</strong><span>{user.email}</span></div><button onClick={logout} aria-label="Sign out" title="Sign out"><LogOut size={17} /></button></div><div className="sidebar-status"><i /><span>Secure session active</span></div>
      </aside>
