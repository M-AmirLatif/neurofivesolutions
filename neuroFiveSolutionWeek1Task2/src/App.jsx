    ...
    <div id="top" className={styles.app}>
      ...
      <main>
        <section className={styles.hero} aria-labelledby="page-title">
          ...
          <p>
            Search nations across every continent and discover essential facts
            powered by live global data.
          </p>
          {!isLoading && !error && (
            <div className={styles.stats}>
              <strong>{countries.length}</strong>
              <span>countries ready to explore</span>
            </div>
          )}
        </section>
